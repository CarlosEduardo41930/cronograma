...
function CreateProfessor() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await api.post('/users/professor', { nome, senha, tipo, descricao });
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-[#E8EFF7]" style={{ fontFamily: "'Syne',sans-serif" }}>Criar Professor</h1>
      </div>
      ...
      <div className="bg-[#111827] border border-[#1F2C42] rounded-2xl p-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs uppercase tracking-widest text-[#8DA4BF] mb-1.5">Nome do professor</label>
