    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-10">
        <Link to="/admin/criar-professor"
          ...
          <div>
            <p className="font-bold text-[#E8EFF7] group-hover:text-blue-400 transition-colors" style={{ fontFamily: "'Syne',sans-serif" }}>Criar Professor</p>
            <p className="text-xs text-[#8DA4BF] mt-0.5">Adicionar novo professor ao sistema</p>
          </div>
        </Link>
