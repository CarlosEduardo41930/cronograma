  ...
  return (
    <AuthContext.Provider value={{ user, login, logout }}>
      <Routes>
        ...
        <Route path="/admin" element={requireAuth(user, 'administrador') ? <Layout><AdminPainel /></Layout> : <Navigate to={getRedirect(user)} />} />
        <Route path="/admin/criar-professor" element={requireAuth(user, 'administrador') ? <Layout><CreateProfessor /></Layout> : <Navigate to={getRedirect(user)} />} />
        <Route path="/admin/criar-turma" element={requireAuth(user, 'administrador') ? <Layout><CreateTurma /></Layout> : <Navigate to={getRedirect(user)} />} />
        <Route path="/admin/excluir/:tipo/:id" element={requireAuth(user, 'administrador') ? <Layout><ExcluirAdmin /></Layout> : <Navigate to={getRedirect(user)} />} />
