...
<body class="bg-[#0B0F1A] text-[#E8EFF7] min-h-screen">
  ...
  <div class="relative z-10 max-w-3xl mx-auto px-6 pt-10 pb-16">
    ...
    <div class="mb-8">
      ...
      <h1 class="text-3xl font-bold text-[#E8EFF7]" style="font-family:'Syne',sans-serif;">Criar Turma</h1>
    </div>
    ...
    <div class="bg-[#111827] border border-[#1F2C42] rounded-2xl p-8">
      <form method="POST" class="space-y-4">
        ...
        <div>
          <label class="block text-xs uppercase tracking-widest text-[#8DA4BF] mb-1.5">Nome do usuário (login)</label>
          <input type="text" name="nome" placeholder="Nome de login da turma" class="field-input" />
        </div>
        ...
        <div>
          <label class="block text-xs uppercase tracking-widest text-[#8DA4BF] mb-1.5">Nome da turma</label>
          <input type="text" name="turma" placeholder="Ex: Turma A — 2026" class="field-input" />
        </div>

        <div>
          <label class="block text-xs uppercase tracking-widest text-[#8DA4BF] mb-1.5">Descrição</label>
          <input type="text" name="descricao" placeholder="Breve descrição da turma" class="field-input" />
        </div>

        <div>
          <label class="block text-xs uppercase tracking-widest text-[#8DA4BF] mb-1.5">Professor responsável</label>
          <select name="professor" class="field-input">
