...
<body class="bg-[#0B0F1A] text-[#E8EFF7] min-h-screen flex items-center justify-center p-6">
  ...
  <div class="relative z-10 w-full max-w-md">
    ...
    <div class="bg-[#111827] border border-[#1F2C42] rounded-2xl p-8 text-center"
      ...
      <h1 class="text-2xl font-bold text-[#E8EFF7] mb-2" style="font-family:'Syne',sans-serif;">Excluir Aula</h1>
      <p class="text-sm text-[#8DA4BF] mb-1">Tem certeza que deseja excluir esta aula?</p>
    ...
    <div class="text-center mt-4">
      <a href="turma_aulas.php?turma=<?=$turma?>" class="text-xs text-[#3A4F6A] hover:text-[#8DA4BF] transition-colors">
