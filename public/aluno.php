...
<head>
  <meta charset="UTF-8" />
  <title>EduPortal — Minhas Aulas</title>
...
<body class="bg-[#0B0F1A] text-[#E8EFF7] min-h-screen flex flex-col">
  ...
  <main class="relative z-10 max-w-5xl mx-auto px-6 pt-10 pb-16 w-full flex-1">
    ...
    <div class="mb-8">
      <p class="text-xs uppercase tracking-widest text-[#8DA4BF] mb-1">Área do aluno</p>
      <h1 class="text-3xl font-bold text-[#E8EFF7]" style="font-family:'Syne',sans-serif;">Minhas Aulas</h1>
    </div>
